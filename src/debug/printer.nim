...
# FW
method accept(self: Node, visitor: PrinterAST): void
...
method visit(self: PrinterAST, node: Node): void {.base.} =
  self.printNode(node.kind)
  
method visit(self: PrinterAST, node: ValueNode): void =
  self.printNode(node.kind, node.value.replace("\n", "\\n"))
  
method visit(self: PrinterAST, node: BodyNode): void =
  self.printNode(node.kind)
  self.depth += 1
...
method visit(self: PrinterAST, node: ListItemNode): void =
...
method visit(self: PrinterAST, node: ListNode): void =
  self.printNode(node.kind)
  self.depth += 1
...
method visit(self: PrinterAST, node: CodeBlockNode): void =
  self.printNode(node.kind, node.language)
  
method visit(self: PrinterAST, node: EmphasisNode): void =
  self.printNode(node.kind)
  self.depth += 1
  node.value.accept(self)
  self.depth -= 1

method visit(self: PrinterAST, node: LinkNode): void =
  self.printNode(node.kind, node.href)
  self.depth += 1
  node.content.accept(self)
  self.depth -= 1
  
method visit(self: PrinterAST, node: ImageNode): void =
